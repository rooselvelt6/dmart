...
pub fn api_version() -> &'static str {
    API_VERSION.get_or_init(|| {
        std::env::var("DMART_API_VERSION").unwrap_or_else(|_| "v1".to_string())
    })
}
...
pub fn build_v1_router(
    ...
    let protected_router = Router::new()
        ...
        .route("/admin/camas/disponibles", get(crate::api::admin::get_camas_disponibles))
        .route("/admin/check-camas", get(crate::api::admin::check_camas_disponibles))
        .route(
            "/admin/equipos",
        ...
        .route("/admin/staff/{id}/toggle", post(crate::api::admin::toggle_user_active))
        .route("/admin/audit", get(crate::api::admin::get_audit_logs_api))
        .route("/admin/audit/critical", get(crate::api::admin::get_audit_critical_api))
        .route(
            "/admin/audit/cleanup",
            post(crate::api::admin::run_audit_retention_cleanup),
        )
        .route("/admin/audit/scores", get(crate::api::score_audit::verify_scores))
        .route(
            "/admin/tenants",
            get(crate::api::tenant::list_tenants_api).post(crate::api::tenant::create_tenant_api),
        )
        .route("/admin/tenants/audit", get(crate::api::tenant::audit_tenancy_api))
        .route(
        ...
        .route("/patients/{id}/egreso", post(crate::api::patients::egreso_paciente))
        .route("/patients/{id}/timeline", get(crate::api::patients::patient_timeline))
        .route("/cds/plans", get(crate::api::cds::list_plans))
        .route("/cds/evaluate", post(crate::api::cds::evaluate_cds))
        .route(
            "/patients/{id}/measurements",
            get(crate::api::measurements::get_measurements).post(crate::api::measurements::create_measurement),
        )
        .route(
            "/patients/{id}/measurements/last",
            get(crate::api::measurements::get_last_measurement),
        )
        .route("/patients/{id}/scales/apache", post(crate::api::scales::calc_apache))
        .route("/patients/{id}/scales/gcs", post(crate::api::scales::calc_gcs))
        .route("/patients/{id}/scales/news2", post(crate::api::scales::calc_news2))
        .route("/patients/{id}/scales/sofa", post(crate::api::scales::calc_sofa))
        .route("/patients/{id}/scales/saps3", post(crate::api::scales::calc_saps3))
        .route("/patients/{id}/scales/history", get(crate::api::scales::scale_history))
        .route("/patients/{id}/export/csv", get(crate::api::export::export_csv))
        .route("/patients/{id}/export/pdf", get(crate::api::export::export_pdf))
        .route(
            "/admin/institucion",
            get(crate::api::institucion::get_institucion).put(crate::api::institucion::upsert_institucion),
        )
        .route("/diagnosticos", get(crate::api::diagnosticos::list_diagnosticos))
        .route("/diagnosticos/search", get(crate::api::diagnosticos::search_diagnosticos))
        .route("/sandbox/generate", post(crate::api::sandbox::generate_patients))
        .route("/sandbox/clear", post(crate::api::sandbox::clear_sandbox))
        .route("/devices/status", get(crate::api::registry::device_status_summary))
        .route(
            "/devices",
        ...
        .route("/devices/{id}/heartbeat", post(crate::api::registry::heartbeat_device))
        .route("/data-quality/validate", post(crate::api::quality::validate_message))
        .route("/data-quality/report", get(crate::api::quality::quality_report))
        .route("/data-quality/summary", get(crate::api::quality::quality_summary))
        .route(
            "/escalation/policies",
            get(crate::api::escalation::list_policies).post(crate::api::escalation::set_policy),
        )
        .route("/escalation/active", get(crate::api::escalation::active_escalations))
        .route("/escalation/{id}/ack", post(crate::api::escalation::acknowledge_alert))
        .route("/escalation/{id}/escalate", post(crate::api::escalation::escalate_alert))
        .route(
            "/teleicu/sessions",
            get(crate::api::teleicu::list_sessions).post(crate::api::teleicu::start_session),
        )
        .route("/teleicu/sessions/{id}/end", post(crate::api::teleicu::end_session))
        .route("/teleicu/live/{id}", get(crate::api::teleicu::live_view))
        .route("/fhir/Patient", get(crate::api::fhir::fhir_patient_search))
        .route("/fhir/Patient/{id}", get(crate::api::fhir::fhir_patient_get))
        .route("/fhir/Patient/{id}/Observation", get(crate::api::fhir::fhir_observation_list))
        .route("/fhir/Patient/{id}/Condition", get(crate::api::fhir::fhir_condition_list))
        .route("/fhir/Patient/{id}/DiagnosticReport", get(crate::api::fhir::fhir_diagnostic_report))
        .route("/fhir/Patient/{id}/DiagnosticReport/QR", get(crate::api::fhir::fhir_diagnostic_report_qr))
        .with_state(database.clone());
    ...
    Router::new()
        ...
        .layer(middleware::from_fn_with_state(version_state.clone(), version_header_middleware))
...
pub fn build_legacy_router(
    ...
    Some(
        Router::new()
            .merge(v1_router)
            .layer(middleware::from_fn_with_state(version_state, version_header_middleware)),
    )
}
