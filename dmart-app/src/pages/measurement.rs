...
pub fn MeasurementPage() -> impl IntoView {
    ...
    let _ = query
        .get()
        .get("escala")
        .map(|s| set_escala.set(EscalaMedir::from_param(&s)));
    ...
    let gcs_score = Memo::new(move |_| gcs_data.get().total());
        ...
        spawn_local(async move {
            let res = match esc {
                ...
                EscalaMedir::SOFA => {
                    ...
                    api::calc_sofa(
                        &pid,
                        d.pao2.unwrap_or(80.0),
                        d.fio2,
                        d.plaquetas,
                        d.bilirrubina,
                        d.presion_arterial_media,
                        d.vasopresores,
                        d.dosis_vasopresor,
                        g.total(),
                        d.creatinina,
